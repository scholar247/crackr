...
// Organizer/admin only — per-question (correct/wrong/skip %) and per-topic accuracy,
// aggregated across every completed attempt.
export async function GET(_req: Request, { params }: { params: Promise<{ id: string }> }) {
  ...
  return apiSuccess({ questions, topics });
}
